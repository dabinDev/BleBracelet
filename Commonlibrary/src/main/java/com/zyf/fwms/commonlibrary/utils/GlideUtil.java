...
public class GlideUtil {
    ...
    public RequestOptions getImageOption(int error) {
        RequestOptions options = new RequestOptions().placeholder(error)//加载成功之前占位图
    ...
    public RequestOptions getHeaderOption() {
        RequestOptions options = new RequestOptions().placeholder(R.mipmap.icon_header_default)//加载成功之前占位图
                .error(R.mipmap.icon_header_default)//加载错误之后的错误图
