...
public class ErrorToastView extends View {
    ...
    private void initRect() {
        ...
        leftEyeRectF = new RectF(mPadding + mEyeWidth - mEyeWidth, mWidth / 3 - mEyeWidth, mPadding + mEyeWidth + mEyeWidth, mWidth / 3 + mEyeWidth);
        rightEyeRectF = new RectF(mWidth - mPadding - 5 * mEyeWidth / 2, mWidth / 3 - mEyeWidth, mWidth - mPadding - mEyeWidth / 2, mWidth / 3 + mEyeWidth);
    }
