package github.opensource.dialog.popwindow.window;
...
import github.opensource.dialog.popwindow.PopSimpleAnimationListener;
import github.opensource.dialog.popwindow.PopWindow;
import github.opensource.dialog.popwindow.view.PopDownView;
import github.opensource.dialog.popwindow.viewinterface.PopWindowInterface;
...
public class PopDownWindow extends PopupWindow implements PopWindowInterface, View.OnClickListener, PopWindowInterface.OnStartShowListener, PopWindowInterface.OnStartDismissListener {
    ...
    private void initContentView(View view, CharSequence title, CharSequence message) {
        mPopDownView = view.findViewById(R.id.popDownView);
        mPopDownView.setPopWindow(mPopWindow);
        mPopDownView.setTitleAndMessage(title, message);

        mContentLayout = view.findViewById(R.id.layout_top);
        mContainLayout = view.findViewById(R.id.layout_contain);
    }
    ...
    private void initAnim() {
        mPopOpenAnimation = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, -1, Animation.RELATIVE_TO_SELF, 0);
        mPopOpenAnimation.setDuration(mActivity.getResources().getInteger(R.integer.pop_animation_duration));
        mPopCloseAnimation = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, -1.0f);
