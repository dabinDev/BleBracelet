...
import github.opensource.dialog.popwindow.view.PopItemView;
import github.opensource.dialog.popwindow.view.PopLineView;
...
public class PopWindowHelper {
    ...
    private static boolean isLineView(View view) {
        ...
        return PopLineView.TAG_LINE_VIEW.equals(tag);
    }
}
