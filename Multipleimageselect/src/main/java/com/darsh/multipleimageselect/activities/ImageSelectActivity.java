...
public class ImageSelectActivity extends HelperActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                /*String temp = getResources().getString(R.string.selected);*/
                String temp = "已选择";
                actionMode.setTitle(countSelected + " " + temp);
    ...
    private class ImageLoaderRunnable implements Runnable {
        ...
        public void run() {
            ...
            Cursor cursor = getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, projection, MediaStore.Images.Media.BUCKET_DISPLAY_NAME + " =?", new String[]{album}, MediaStore.Images.Media.DATE_ADDED);
            if (cursor == null) {
