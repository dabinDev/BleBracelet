...
public class Luban {
    ...
    public void launch(final OnCompressListener listener) {
        asObservable().observeOn(AndroidSchedulers.mainThread()).doOnSubscribe(new Consumer<Disposable>() {
            @Override
    ...
    public void launch(final OnMultiCompressListener listener) {
        asListObservable().observeOn(AndroidSchedulers.mainThread()).doOnSubscribe(new Consumer<Disposable>() {
            @Override
            public void accept(Disposable disposable) {
                listener.onStart();
            }
