...
public class PictureImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            contentHolder.contentView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!new File(path).exists()) {
                        Toast.makeText(context, context.getString(R.string.picture_error), Toast.LENGTH_LONG).show();
                        return;
                    }
                    ...
                    else if (picture == PictureConfig.TYPE_AUDIO && (enablePreviewAudio || selectMode == PictureConfig.SINGLE)) {
                        int index = showCamera ? position - 1 : position;
                        imageSelectChangedListener.onPictureClick(image, index);
                    }
                    else {
    ...
    public void selectImage(ViewHolder holder, boolean isChecked, boolean isAnim) {
        ...
        if (isChecked) {
            if (isAnim) {
                if (animation != null) holder.check.startAnimation(animation);
            }
    ...
    public class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public HeaderViewHolder(View itemView) {
            ...
            String title = mimeType == PictureMimeType.ofAudio() ? context.getString(R.string.picture_tape) : context.getString(R.string.picture_take_picture);
