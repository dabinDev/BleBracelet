...
public class PictureExternalPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    private void showDownLoadDialog(final String path) {
        final CustomDialog dialog = new CustomDialog(PictureExternalPreviewActivity.this, ScreenUtils.getScreenWidth(PictureExternalPreviewActivity.this) * 3 / 4, ScreenUtils.getScreenHeight(PictureExternalPreviewActivity.this) / 4, R.layout.picture_wind_base_dialog_xml, R.style.Theme_dialog);
    ...
    public void showLoadingImage(String urlPath) {
        try {
            ...
            String path = PictureFileUtils.createDir(PictureExternalPreviewActivity.this, System.currentTimeMillis() + ".png", directory_path);
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (media != null) {
                ...
                if (isGif && !media.isCompressed()) {
                    ...
                    Glide.with(PictureExternalPreviewActivity.this).asGif().apply(gifOptions).load(path).listener(new RequestListener<GifDrawable>() {
                        @Override
                    ...
                    Glide.with(PictureExternalPreviewActivity.this).load(path).apply(options).listener(new RequestListener<Drawable>() {
                        @Override
