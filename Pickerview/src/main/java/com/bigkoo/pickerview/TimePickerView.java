...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void setRangDate() {
        ...
        if (startDate != null && endDate != null) {
            ...
            if (date == null || date.getTimeInMillis() < startDate.getTimeInMillis() || date.getTimeInMillis() > endDate.getTimeInMillis()) {
                date = startDate;
            }
    ...
    public interface OnTimeDissmissListener {
        void onTimeSelect(Date date, View v);
    }
    ...
    public static class Builder {
        ...
        //Required
        public Builder(Context context, OnTimeSelectListener listener, OnDismissListener dismissListener) {
            this.context = context;
            this.timeSelectListener = listener;
            this.dismissListener = dismissListener;
        }

        public Builder(Context context, String str_Title, OnTimeSelectListener listener) {
            this.context = context;
            this.timeSelectListener = listener;
            ...
            this.dividerColor = Color.parseColor("#689DF8");
            this.textColorCenter = Color.parseColor("#000000");
            this.textColorOut = Color.parseColor("#666666");
            this.dividerColor = Color.parseColor("#689DF8");
            this.Str_Cancel = "取消";
            this.Color_Cancel = Color.parseColor("#999999");
            this.Str_Submit = "确定";
            this.Color_Submit = Color.parseColor("#689DF8");
            this.Size_Content = 20;
            this.Size_Title = 19;
        }


        public Builder(Context context, String str_Title, boolean setDateFromNow, OnTimeSelectListener listener) {
            this.context = context;
            this.timeSelectListener = listener;
            this.type = new boolean[]{true, true, true, false, false, false};
            this.label_year = "";
