...
public class PageNavigationView extends ViewGroup {
    ...
    public PageNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PageNavigationView);
        ...
        private ObjectAnimator getAnimator() {
            ...
            if (animator == null) {
                ...
                if (mEnableVerticalLayout) {//垂直布局向左隐藏
                    animator = ObjectAnimator.ofFloat(PageNavigationView.this, "translationX", 0, -PageNavigationView.this.getWidth());
                }
                else {//水平布局向下隐藏
                    animator = ObjectAnimator.ofFloat(PageNavigationView.this, "translationY", 0, PageNavigationView.this.getHeight());
                }
