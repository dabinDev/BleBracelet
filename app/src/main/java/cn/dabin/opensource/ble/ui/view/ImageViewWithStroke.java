...
/**
 * Project :  yunaandroid.
 * Package name: com.renwei.yunlong.icon_work_watch
 * Created by :  Benjamin.
 * Created time: 2017/12/1 16:56
 * Changed by :  Benjamin.
 * Changed time: 2017/12/1 16:56
 * Class description:
 */

public class ImageViewWithStroke extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public ImageViewWithStroke(Context paramContext) {
        super(paramContext);
    }

    public ImageViewWithStroke(Context paramContext, AttributeSet paramAttributeSet) {
        this(paramContext, paramAttributeSet, 0);
    }

    public ImageViewWithStroke(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    ...
    protected void onDraw(Canvas paramCanvas) {
        ...
        /** 保存layer */
        @SuppressLint("WrongConstant") int layer = paramCanvas.saveLayer(0.0F, 0.0F, width, height, null, 31);
        /** 设置drawable的大小 */
