...
public class FormatUtil {
    ...
    public static String B2M(int b) {
        ...
        String p = decimalFormat.format(((float) b) / ((float) 1000) / ((float) 1024));
        return p + "M";
    }
    ...
    public static boolean isMobileNO(String mobiles) {
		 ...
		 */
        String telRegex = "[1][3456789]\\d{9}";//"[1]"代表第1位为数字1，"[34589]"代表第二位可以为3、4、5、8中的一个，"\\d{9}"代表后面是可以是0～9的数字，有9位。
     ...
     * 验证手机格式
     */
    public static boolean isfixedLineTelephone(String phone) {
    ...
    public static boolean isPasswordLength(String pwd) {
        return pwd != null && pwd.length() >= 6 && pwd.length() >= 12;
    }
    ...
    private static boolean isDataFormat(String str) {
        ...
        String regxStr = "^((\\d{2}(([02468][048])|([13579][26]))[\\-\\/\\s]?((((0?[13578])|(1[02]))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])))))|(\\d{2}(([02468][1235679])|([13579][013456789]))[\\-\\/\\s]?((((0?[13578])|(1[02]))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\\-\\/\\s]?((0?[1-9])|(1[0-9])|(2[0-8]))))))(\\s(((0?[0-9])|([1-2][0-3]))\\:([0-5]?[0-9])((\\s)|(\\:([0-5]?[0-9])))))?$";
